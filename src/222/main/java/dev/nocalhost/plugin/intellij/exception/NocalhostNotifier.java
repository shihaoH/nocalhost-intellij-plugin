...
public class NocalhostNotifier {
    ...
    public Notification notifyError(@NlsContexts.NotificationTitle @NotNull String title,
        ...
        return notify(NOCALHOST_ERROR_NOTIFICATION, NOCALHOST_ERROR_NOTIFICATION_ID, title, content, NotificationType.ERROR, () -> {
    ...
    public void notifyBinaryNotFound(String binary) {
        ...
        notify(NOCALHOST_ERROR_NOTIFICATION, NOCALHOST_ERROR_NOTIFICATION_ID, "Nocalhost", content, NotificationType.ERROR, () -> {
    ...
    public void notifyVersionTips() {
        ...
        notify(NOCALHOST_ERROR_NOTIFICATION, NOCALHOST_ERROR_NOTIFICATION_ID, "Nocalhost", content, NotificationType.ERROR, () -> BrowserUtil.browse("https://plugins.jetbrains.com/plugin/16058-nocalhost/versions"));
    }
    ...
    private static Notification createNotification(@NotNull NotificationGroup notificationGroup,
        ...
        if (listener != null) {
            NotificationAction action = NotificationAction.createSimple(title, listener);
